...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFuYS1zb2JoeSIsImEiOiJjbGd4dDBqYWowMnFvM3RwYmk2MDhtZWQ0In0.aQbwKoVSL87pge5LOcyXqw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/rana-sobhy/clgxtqdlz007z01qtgdo8busm',
    // style URL
    scrollZoom: false
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'data' ? 'http://localhost:3000/api/v1/users/me' : 'http://localhost:3000/api/v1/users/me/password';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51N1rIXIoTnkRliPmXZQp6RnChX0Jai163pKoKOljC7ajXJronPrkUqrykCaWPSqrKWhGfrBb1mtqsEp9LFKSrI8U00XhButo0O');
...
var userSettingsForm = document.querySelector('.form-user-data');
